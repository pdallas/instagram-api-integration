...
def getAccountInfo(params):
    ...
    endpointParams['fields'] = 'business_discovery.username(' + params[
        'ig_username'] + '){username,website,name,ig_id,id,profile_picture_url,biography,follows_count,followers' \
                         '_count,media_count}'  # string of fields to get back with the request for the account
