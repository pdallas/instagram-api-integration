...
def getCreds():
    ...
    #creds['page_id'] = '105140544217695'  # users page id
    #creds['instagram_account_id'] = '17841406665384366'  # users instagram account id
    #creds['ig_username'] = 'thewebhog'  # ig username
    return creds
